...
// ------------------------------
    ...
    drive_pub = n.advertise<ackermann_msgs::AckermannDriveStamped>("/car" + bot_num + "/ackermann_cmd", 1);
...
// -----------------------------------
    cout<< bot_num << endl;
    ros::Subscriber sub = n.subscribe("/car" + bot_num +"/position", 1, getViconPosition);
// --------------------------
